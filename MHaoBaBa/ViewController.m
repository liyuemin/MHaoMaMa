...
- (void)viewDidLoad {
  ...
  [[DBQueueManager shareDBQueueManager] createTable:@"MHaoBaBa"];
    ...
    NSMutableArray *brands = [[DBQueueManager shareDBQueueManager] queryFromTable:@"BrandTable" Where:where Start:nil Limit:nil Desc:NO OrderBy:nil];

    
        NSMutableArray *tags = [[DBQueueManager shareDBQueueManager] queryFromTable:@"rankingTagsTabel" Where:where Start:nil Limit:nil Desc:NO OrderBy:nil];
